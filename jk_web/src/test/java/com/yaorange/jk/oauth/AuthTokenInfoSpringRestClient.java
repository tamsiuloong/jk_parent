...
public class AuthTokenInfoSpringRestClient {
    ...
    private static HttpHeaders getHeadersWithClientCredentials(){
    	String plainClientCredentials="jk_front:123456";
    	String base64ClientCredentials = new String(Base64.encodeBase64(plainClientCredentials.getBytes()));
    	
    	HttpHeaders headers = getHeaders();
        String info = "Basic " + base64ClientCredentials;
        System.out.println(info);
        headers.add("Authorization", info);
    	return headers;
    }    
    ...
    private static void listAllUsers(AuthTokenInfo tokenInfo){
        ...
        String url = REST_SERVICE_URI+"system/user"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token();
